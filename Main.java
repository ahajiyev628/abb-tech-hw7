...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        RoboCat rc = new RoboCat(AnimalSpecies.ROBOCAT, "wimel", 10, 49, new String[]{"eat", "play"});
        System.out.println(rc.describePet());

        Fish f = new Fish(AnimalSpecies.FISH, "wimel", 10, 70, new String[]{"eat", "play"});
        System.out.println(f.describePet());

        Dog dg = new Dog(AnimalSpecies.DOG, "wimel", 10, 51, new String[]{"eat", "play"});
